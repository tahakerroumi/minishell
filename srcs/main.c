...
/*   Updated: 2024/09/15 13:06:27 by tkerroum         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_command *parser(char *command_line)
{
	...
	///// form t_command commad to pass it then to the execution part
	...
	/////////////////////////////////////////////////////////
	free_tokens(token, F_MASK|F_TOKEN|F_ORIGINAL|F_CONTENT);///////////
	return (NULL);///////////////////////////////////////////
	/////////////////////////////////////////////////////////
}
